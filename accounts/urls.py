...
from .views import RegisterView, MeView, ChangePasswordView, LogoutView, UserListView, UserDetailView, DepartmentListCreateView, DepartmentDetailView, ColleaguesListView, VisibleEmployeesListView, DeactivateUserView, ActivateUserView
...
urlpatterns = [
    ...
    path('users/visible/', VisibleEmployeesListView.as_view(), name='visible_employees'),
]